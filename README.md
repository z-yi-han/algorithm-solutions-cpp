...
## _前言_
_这是作者用来记录和分享算法过程的学习,会涉及到诸多算法题型,初步计划先以专题形式更新若干,然后再专门更新三种算法类型,作者会将一道题插接成读题,思路,以及最后的code部分,其中code以及题解图像会放在对应文件中,持续更新ing。_  
_作者也会在稀土掘金更新博客,欢迎关注：https://juejin.cn/column/7606136581062393883_
## 题型一:双指针
